...
/**
 * Classe DaoConducteurJdbcImpl
 */
public class DaoConducteurJdbcImpl implements DaoConducteur {

    public static final String RQT_SELECT_ALL = "SELECT numConducteur,nom,prenom FROM CONDUCTEURS";
    public static final String RQT_SELECT_BY_ID = "SELECT numConducteur,nom,prenom FROM CONDUCTEURS WHERE numConducteur = ?";
    ...
    public static final String RQT_BEFORE_DELETE = "UPDATE VOITURES SET numConducteur = NULL WHERE numConducteur = ?";
    public static final String RQT_DELETE = "DELETE FROM CONDUCTEURS WHERE numConducteur = ?";

    public static Logger logger = MonLogger.getLogger("DaoConducteurJdbcImpl");
    ...
    public List<Conducteur> selectAll() throws DaoException {
        ...
        try (Connection cnx = Connexion.getConnection()) {
            ...
            logger.severe("ERREUR DaoConducteurJdbcImpl.selectAll() " + ex.getMessage());
    ...
    public Conducteur selectById(int id)  throws DaoException {
        ...
        try (Connection cnx = Connexion.getConnection()) {
            ...
            logger.severe("ERREUR DaoConducteurJdbcImpl.selectById() " + ex.getMessage());
            throw new DaoException(ex.getMessage());
        }
        return UnConducteur;
    }
    ...
    public boolean insert(Conducteur UnConducteur) throws DaoException
    {
        ...
        {
            logger.severe("ERREUR DaoConducteurJdbcImpl.insert() " + ex.getMessage());
            throw new DaoException(ex.getMessage());
        }
        return nbLignes > 0;
    }
    ...
    public boolean update(Conducteur UnConducteur)  throws DaoException {
        ...
        {
            logger.severe("ERREUR DaoConducteurJdbcImpl.update() " + ex.getMessage());
            throw new DaoException(ex.getMessage());
        }
        return nbLignes > 0;
    ...
    private void beforedelete(int id) throws DaoException
    {
        ...
        {
            logger.severe("ERREUR DaoConducteurJdbcImpl.beforedelete() " + ex.getMessage());
            throw new DaoException(ex.getMessage());
        }
    }
    ...
    public boolean delete(int id) throws DaoException
    {
        ...
        {
            logger.severe("ERREUR DaoConducteurJdbcImpl.delete() " + ex.getMessage());
            throw new DaoException(ex.getMessage());
        }
        return nbLignes > 0 ;
